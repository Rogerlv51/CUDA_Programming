...
// 测试二维矩阵加法在分配不同grid和block维度时的运行效率
...
// 结果分析：
/*
Using device 0: NVIDIA GeForce RTX 2050
CPU Execution Time elapsed 0.036897 sec
GPU Execution configuration<<<(128,128),(32,32)>>> Time elapsed 0.002781 sec
Check result success!
GPU Execution configuration<<<(524288,1),(32,1)>>> Time elapsed 0.007395 sec
Check result success!
GPU Execution configuration<<<(128,4096),(32,1)>>> Time elapsed 0.007215 sec
Check result success!

可以看到明显GPU比CPU快很多，并且当我们分配的线程结构不同时，计算效率也会有所区别
*/